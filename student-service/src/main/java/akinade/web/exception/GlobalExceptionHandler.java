...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    private static final URI NOT_FOUND_TYPE = URI.create("https://api.akinade.com/errors/not-found");
    private static final URI ISE_FOUND_TYPE = URI.create("https://api.akinade.com/errors/server-error");
